package br.com.jusley.hexagonal.infrastructure.rest;
...
public class EventController {
    ...
    public ResponseEntity<?> create(@RequestBody NewEventDTO dto) {
        try {
            final var output = createEventUseCase.execute(new CreateEventUseCase.Input(dto.name(), dto.date(), dto.totalSpots(), dto.partnerId()));
