...
public class EventEntity {
    ...
    public int totalSpots() { return totalSpots;}
    ...
    public Set<EventTicketEntity> tickets() { return tickets;}

    public void setTickets(Set<EventTicketEntity> tickets) { this.tickets = tickets;}
